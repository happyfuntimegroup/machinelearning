...
def simple_linear(X_train, y_train, X_val, y_val):
    ...
    print("LinearRegression r2:", r2_score(y_val, y_pred_val)) # 0.39388060841374883
    print("LinearRegression MAE:", mean_absolute_error(y_val, y_pred_val)) # 0.7802264002686868
    return reg
...
def sdg_reg (X_train, y_train, X_val, y_val):
    ...
    print("mae:", mae) # 0.8008385611764096
    print("r2", r2) # 0.35885187794244977
    return reg
...
def pois_reg (X_train, y_train, X_val, y_val):
    ...
    print('pois_reg r2:', r2_score(y_val, y_pred_val)) # -47.584830044022574
    print("pois_reg MAE:", mean_absolute_error(y_val, y_pred_val)) # 0.976145189576343
